      ...
      <ul class="sidebar navbar-nav">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="categoryDropdown">
            ...
            <a class="dropdown-item" href="/addcategory">AddCategory</a>
            <a class="dropdown-item" href="/manegcategory">ManegCategory</a>
          ...
          <div class="dropdown-menu" aria-labelledby="brandDropdown">
            ...
            <a class="dropdown-item" href="/addbrand">AddBrand</a>
            <a class="dropdown-item" href="/manegbrand">ManegBrand</a>
          ...
          <div class="dropdown-menu" aria-labelledby="productDropdown">
            ...
            <a class="dropdown-item" href="/manegproduct">ManegProduct</a>
          ...
          <div class="dropdown-menu" aria-labelledby="productDropdown">
            ...
            <a class="dropdown-item" href="/addslider">AddSlider</a>
            <a class="dropdown-item" href="/manegslider">ManegSlider</a>
          
          </div>
        </li>
          <li class="nav-item">
          <a class="nav-link" href="/manegorder">
            <i class="fas fa-fw fa-chart-area"></i>
            <span>Manegorder</span></a>
        </li>
        <li class="nav-item">
