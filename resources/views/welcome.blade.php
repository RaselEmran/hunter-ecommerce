...
<body>
                    ...
                    <div class="col-sm-8">
                        <div class="shop-menu pull-right">
                            ...
                            <?php  $customer_id =Session::get('id'); ?>
                             @if($customer_id )
                                <li><a href="/customeraccount"><i class="fa fa-user"></i> Account</a></li>
                                @else
                                <li><a href="/login-check"><i class="fa fa-user"></i> Account</a></li>
                                @endif
    ...
    <?php 
$slider =DB::table('sliders')->limit(4)->get();
...
<div class="col-sm-6">
     ...
     <div class="col-sm-6">
        ...
        <div class="carousel-caption"
            ...
            <h1>
                <a href="{{ url('YOUR_URL')  }}"> {{ $item->title }}</a>
            </h1>
        </div>
</div>
    </div>
@endforeach
             <!--                <div class="item">
                                ...
                                <div class="col-sm-6">
                                    <img src="{{'/fontend'}}/images/home/girl2.jpg" class="girl img-responsive" alt="" />
                                    <img src="{{'/fontend'}}/images/home/pricing.png"  class="pricing" alt="" />
                                </div>
                            </div>
                            ...
                            <div class="item">
                                ...
                                <div class="col-sm-6">
                                    <img src="{{'/fontend'}}/images/home/girl3.jpg" class="girl img-responsive" alt="" />
                                    <img src="{{'/fontend'}}/images/home/pricing.png" class="pricing" alt="" />
                                </div>
                            </div> -->
    ...
    <section>
        ...
        <?php 
         $all_category =DB::table('categories')
             ...
             foreach ($all_category as  $cat_value) {
                 ?>
                <div class="panel panel-default">
                    <div class="panel-heading">
                    <div class="panel-text">
                        <h4 class="panel-title"><a href="/categorybyproduct/{{$cat_value->id}}"><?php echo $cat_value->name ?></a></h4>
                    </div>
                            ...
                            <div class="brands-name">
                                ...
                                <?php 
                                    $all_brand =DB::table('brands')
                                                   ->get();
                                             if ($all_brand) {
                                                 foreach ($all_brand as $b_value) {
                                                    ?>

                                        <li><a href="/brandbyproduct/{{$b_value->id}}"> <span class="pull-right">(<?php echo $b_value->quantity ?>)</span><?php echo $b_value->name ?></a></li>
                                ...
                                <div class="item active">   
                                        ...
                                        <div class="product-image-wrapper">
                                            <div class="single-products">
                                                <div class="productinfo text-center">
                                                    <img src="{{'/fontend'}}/images/home/recommend1.jpg" alt="" />
                                                    <h2>$56</h2>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="product-image-wrapper">
                                            <div class="single-products">
                                                <div class="productinfo text-center">
                                                    <img src="{{'/fontend'}}/images/home/recommend2.jpg" alt="" />
                                                    <h2>$56</h2>
                                                    <p>Easy Polo Black Edition</p>
                                                    <a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                                                </div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="product-image-wrapper">
                                            <div class="single-products">
                                                <div class="productinfo text-center">
                                                    <img src="{{'/fontend'}}/images/home/recommend3.jpg" alt="" />
                                                    <h2>$56</h2>
                                                    <p>Easy Polo Black Edition</p>
                                                    <a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                                                </div>
        ...
        <div class="footer-top">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-7">
                            ...
                            <div class="video-gallery text-center">
                                <a href="#">
                                    <div class="iframe-img">
                                        <img src="{{'/fontend'}}/images/home/iframe1.png" alt="" />
                                    </div>
                        ...
                        <div class="col-sm-3">
                            <div class="video-gallery text-center">
                                <a href="#">
                                    <div class="iframe-img">
                                        <img src="{{'/fontend'}}/images/home/iframe2.png" alt="" />
                                    </div>
                                    <div class="overlay-icon">
                                        <i class="fa fa-play-circle-o"></i>
                                    </div>
                        ...
                        <div class="col-sm-3">
                            <div class="video-gallery text-center">
                                <a href="#">
                                    <div class="iframe-img">
                                        <img src="{{'/fontend'}}/images/home/iframe3.png" alt="" />
                                    </div>
                                    <div class="overlay-icon">
                                        <i class="fa fa-play-circle-o"></i>
                                    </div>
                        ...
                        <div class="col-sm-3">
                            <div class="video-gallery text-center">
                                <a href="#">
                                    <div class="iframe-img">
                                        <img src="{{'/fontend'}}/images/home/iframe4.png" alt="" />
                                    </div>
                                    <div class="overlay-icon">
                                        <i class="fa fa-play-circle-o"></i>
                                    </div>
                    ...
                    <div class="col-sm-3">
                        <div class="address">
                            <img src="{{'fontend'}}/images/home/map.png" alt="" />
