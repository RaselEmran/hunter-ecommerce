  ...
  <body class="bg-dark">
    ...
    <div class="container">
      <div class="card card-login mx-auto mt-5">
        ...
        <div class="card-body">
          <form method="post" action="{{url('/admin-dashbord')}}">
          {{csrf_field()}}
            ...
            <div class="form-group">
              <div class="form-label-group">
                <input type="password" name="admin_password" id="inputPassword" class="form-control" placeholder="Password" required="required">
